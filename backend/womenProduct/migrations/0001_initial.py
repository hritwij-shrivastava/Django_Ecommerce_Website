    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(auto_now_add=True)),
                ('product_brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='womenProduct.womenbrandtable')),
                ('product_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='womenProduct.womencategorytable')),
                ('product_tag', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='womenProduct.womentagstable')),
            ],
        ),
        migrations.CreateModel(
            name='ImagesForWomenProduct',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product_opt_img', models.ImageField(upload_to='product_images')),
                ('woman_product_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='womenProduct.womenproducttable')),
            ],
        ),
    ]
