    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(auto_now_add=True)),
                ('product_brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='menProduct.menbrandtable')),
                ('product_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='menProduct.mencategorytable')),
                ('product_tag', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='menProduct.mentagstable')),
            ],
        ),
        migrations.CreateModel(
            name='ImagesForMenProduct',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product_opt_img', models.ImageField(upload_to='product_images')),
                ('man_product_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='menProduct.menproducttable')),
            ],
        ),
    ]
