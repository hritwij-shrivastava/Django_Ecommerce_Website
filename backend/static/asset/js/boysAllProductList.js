$(document).ready(function(){
    ...
    var get_url;
    $("girlzone").on('click',function(){
      window.location.href = base_url +"/girlsproduct";
    });
    ...
    function loadTable(page){
      ...
      $.ajax({
        url: base_url +  '/boys-m-ajax-pagination',
        type: "POST",
        dataType:'json',
        data: {
          page_no:page,
        ...
        success: function(res){
          ...
          $.each(json_data,function(index,data){
            ...
            product_url = base_url + '/boysproduct-description/' + data.fields.product_unique_id
