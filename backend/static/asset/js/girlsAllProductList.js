$(document).ready(function(){
    ...
    var get_url;
    $("boyzone").on('click',function(){
      window.location.href = base_url +"/boysproduct";
    });
    ...
    function loadTable(page){
      ...
      $.ajax({
        url: base_url +  '/girls-ajax-pagination',
        type: "POST",
        dataType:'json',
        data: {
          page_no:page,
        ...
        success: function(res){
          ...
          $.each(json_data,function(index,data){
            ...
            product_url = base_url + '/girlsproduct-description/' + data.fields.product_unique_id
    ...
    loadTable(1);  // on loading page number will be 1
