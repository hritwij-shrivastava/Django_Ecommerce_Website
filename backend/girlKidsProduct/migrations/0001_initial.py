    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='girlKidsProduct.girlbrandtable')),
                ('product_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='girlKidsProduct.girlcategorytable')),
            ],
        ),
        migrations.CreateModel(
            name='girlTagsTable',
        ...
        migrations.CreateModel(
            name='ImagesForGirlProduct',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product_opt_img', models.ImageField(upload_to='product_images')),
                ('woman_product_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='girlKidsProduct.girlproducttable')),
            ],
        ),
        migrations.AddField(
            model_name='girlproducttable',
            name='product_tag',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='girlKidsProduct.girltagstable'),
        ),
    ]
